...
router.post('/dashboard/reset-password', auth(USER_ROLES.SUPER_ADMIN), validateRequest(AuthValidation.createResetPasswordZodSchema), AuthController.resetPasswordByUrl);

router.post('/change-password', auth(...Object.values(USER_ROLES)), validateRequest(AuthValidation.createChangePasswordZodSchema), AuthController.changePassword);
